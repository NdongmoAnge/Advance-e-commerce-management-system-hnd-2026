...
-- Insert Admin User (Updated: angeadmin@gmail.com with password: Ange123!)
INSERT INTO admins (first_name, last_name, email, password_hash) VALUES
('Grace', 'Admin', 'angeadmin@gmail.com', '$2y$12$kG3o2N3.DZJ4tUgz2GxIBOr.ZLQ3f6PQYAcYyV7dNbKN8jMFNgNAu');
...
-- Insert sample suppliers (Updated emails with new pattern)
INSERT INTO suppliers (company_name, contact_name, email, phone_number, address) VALUES
('HP Cameroon', 'Jean Pierre', 'angesupplier1@gmail.com', '+237612345678', 'Rue 1225, Douala'),
('Dell Technologies', 'Marie Claire', 'angesupplier2@gmail.com', '+237623456789', 'Avenue Central, Yaounde'),
('Lenovo Group', 'Paul Biya', 'angesupplier3@gmail.com', '+237634567890', 'Boulevard 34, Limbe');

-- Insert sample users for each role with updated emails and password: Ange123!
-- Note: All passwords are set to 'Ange123!' with this hash: $2y$12$kG3o2N3.DZJ4tUgz2GxIBOr.ZLQ3f6PQYAcYyV7dNbKN8jMFNgNAu
...
('Admin', 'User', 'angeadmin@gmail.com', '+2376512345', 'Cameroon', 'Centre', 'Yaounde', '$2y$12$kG3o2N3.DZJ4tUgz2GxIBOr.ZLQ3f6PQYAcYyV7dNbKN8jMFNgNAu', 1),

-- Client (role_id = 2)
('Client', 'User', 'angeclient@gmail.com', '+2376534567', 'Cameroon', 'Littoral', 'Douala', '$2y$12$kG3o2N3.DZJ4tUgz2GxIBOr.ZLQ3f6PQYAcYyV7dNbKN8jMFNgNAu', 2),

-- Vendeur (role_id = 3)
('Vendeur', 'Sales', 'angevendeur@gmail.com', '+2376545678', 'Cameroon', 'Centre', 'Yaounde', '$2y$12$kG3o2N3.DZJ4tUgz2GxIBOr.ZLQ3f6PQYAcYyV7dNbKN8jMFNgNAu', 3),

-- Gestionnaire Stock (role_id = 4)
('Stock', 'Manager', 'angestock@gmail.com', '+2376556789', 'Cameroon', 'Centre', 'Yaounde', '$2y$12$kG3o2N3.DZJ4tUgz2GxIBOr.ZLQ3f6PQYAcYyV7dNbKN8jMFNgNAu', 4),

-- Responsable Financier (role_id = 5)
('Finance', 'Manager', 'angefinance@gmail.com', '+2376578901', 'Cameroon', 'Centre', 'Yaounde', '$2y$12$kG3o2N3.DZJ4tUgz2GxIBOr.ZLQ3f6PQYAcYyV7dNbKN8jMFNgNAu', 5);
