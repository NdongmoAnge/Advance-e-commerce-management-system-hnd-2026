        ...
        <div class="login-container">
            <div class="login-content">
                <div class="login-welcome">
                    <h2>Welcome back !</h2>
                    <p>Log in to access your account and enjoy all our services.</p>
                ...
                <div class="login-form-container">
                    ...
                    <form class="login-form" method="POST" action="">
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="email" id="email" name="email" value="<?= htmlspecialchars($email) ?>" placeholder="Enter your adresse email">
                            </div>
                        </div>
                    ...
                    <div class="register-link">
                        <p>No account yet? <a href="register.php">S'inscrire</a></p>
                    </div>
                </div>
            </div>
        </div>
