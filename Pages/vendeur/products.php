...
<head>
    ...
    <title>dashboard-card - Stock Manager</title>
...
<body>
    <div class="dashboard-container">
        <div class="dashboard-header">
            <h1 class="dashboard-title">Inventory Manager Dashboard</h1>
            ...
            <div class="dashboard-card">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" style="text-align: center;">No low stock products at the moment</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
