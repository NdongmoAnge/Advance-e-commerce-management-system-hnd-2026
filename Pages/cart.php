...
// WhatsApp number
$whatsappNumber = "+237688061290"; // WhatsApp number provided
...
if (isset($_POST['send_whatsapp'])) {
    ...
    $message = urlencode(
        ...
        "Downlaod your reciepe here: " . $pdfDownloadLink . "\n\n" .
        "Thanks for your commande!"
    );
...
<main class="cart-container">
    ...
    <div class="empty-cart">
        ...
        <p>Discover our product and add items to your card</p>
        <a href="produit.php" class="btn-continue-shopping">
            <i class="fas fa-store"></i> see product
        </a>
    </div>
    <?php else: ?>
...
<div class="cart-item <?= (strpos(strtolower($item['category']), 'Computers') !== false) ? 'tech-product' : '' ?>" id="item-<?= $item['cart_id'] ?>">
    ...
    <div class="item-details">
        ...
        <?php if (!empty($item['specs']) && strpos(strtolower($item['category']), 'Computer') !== false): ?>
    ...
    <div class="item-actions">
        ...
        <div class="cart-summary">
            ...
            <button id="whatsapp-order-btn" class="btn-whatsapp-order">
                <i class="fab fa-whatsapp"></i>  Place order through WhatsApp
            </button>
            <a href="produit.php" class="btn-continue-shopping">
...
<div id="confirmation-modal" class="modal">
    <div class="modal-content">
        ...
        <h2><i class="fas fa-check-circle"></i> Confirm your commande</h2>
        <p>Are your sure you want to place the order for <span id="order-total"><?= number_format($totalAmount, 2, ',', ' ') ?> CFA</span>?</p>
        <div class="modal-actions">
            <button id="confirm-order" class="btn-confirm">Confirm</button>
...
<div id="whatsapp-modal" class="modal">
    <div class="modal-content">
        <span class="close">&times;</span>
        <h2><i class="fab fa-whatsapp"></i> Place your order through WhatsApp</h2>
        ...
        <div class="modal-actions">
            <button id="send-whatsapp-order" class="btn-whatsapp-confirm">
                <i class="fab fa-whatsapp"></i> Send your order
            </button>
            <button id="cancel-whatsapp-order" class="btn-cancel">Cancel</button>
        </div>
    </div>
</div>
...
<div id="success-modal" class="modal">
    <div class="modal-content success">
        ...
        <p>Your order is confirmed. You will receive an email with the details of your order .</p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function removeCartItem(cartId) {
        ...
        .catch(error => {
            showError('Problem of connecting server');
    ...
    function initiatePayment() {
        ...
        .then(data => {
            if (data.success) {
                ...
                hideModal(confirmationModal);
                showError(data.message || 'An error occurred during payement initialisation');
            }
        })
        .catch(error => {
            hideModal(confirmationModal);
            showError('Problem whil');
            console.error('Error:', error);
        });
    }
