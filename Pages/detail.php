        ...
        <div class="product-detail-container">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions-large">
                        ...
                        <a href="#" class="btn btn-secondary btn-large">
                            <i class="fas fa-heart"></i> Added to favorite
                        </a>
                    </div>
            ...
            <div class="product-details-tabs">
                <div class="tab-buttons">
                    ...
                    <button class="tab-button" data-tab="description">Description details</button>
                    <button class="tab-button" data-tab="delivery">Delivery & Garantie</button>
                </div>
                
                <div class="tab-content">
                    <div id="specifications" class="tab-panel active">
                        <h3>Characteristics techniques</h3>
                        <?php
                        ...
                        <?php else: ?>
                            <p>Spécifications details not disponibles for this product.</p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div id="delivery" class="tab-panel">
                        ...
                        <div class="delivery-info">
                            ...
                            <ul>
                                <li><strong>Standard:</strong> Delivery in 3-5 business day</li>
                                <li><strong>Express:</strong> Delivery in 24-48 hours (Additional fees)</li>
                                <li><strong>Order online:</strong> Available for free within 24 hours</li>
                            </ul>
                            
                            <h4>Garantie</h4>
                            <p>All our product are covered by a guaranty of 24 months .Against manufacturing defects.
                           For more information on our politics guaranty, Please check our page <a href="#">Garanties et Services</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
