...
<body>
    ...
    <div id="successModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body" id="successModalText">
               Message send successfully. We will get back to you as soon as possible.
            </div>
            <div class="modal-footer">
                <button class="modal-btn success">Okay</button>
            </div>
        </div>
    </div>
    ...
    <div id="errorModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="modal-btn error">Close</button>
            </div>
        </div>
    </div>
   ...
   <section class="contact-header" id="contact">
    <h1>Contact-Us</h1>
    <p>If you have any question, suggestions, or need assistance? Don't hesitate to contact us. Our team is here to help.</p>
    <div class="company-motto">
        "Your vision, our expertise - Together towards technological excellence"
    </div>
</section>

<section class="contact-content">
    <aside class="contact-info">
        <h3>Information our contact</h3>
        ...
        <div class="info-item">
            ...
            <div class="info-text">
                <h4>Our Address</h4>
                <p>Ndokoti, Carrefour Ndokoti<br>Douala, Cameroon</p>
        ...
        <div class="info-item">
            ...
            <div class="info-text">
                ...
                <p>Mon - Fri : 8am - 6pm<br>Sat : 9am - 4pm<br>Sun : Close</p>
            </div>
        </div>
