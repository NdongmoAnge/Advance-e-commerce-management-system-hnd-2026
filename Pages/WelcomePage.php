...
<body>
        ...
        <div class="nav-content">
            ...
            <div class="nav-links">
                ...
                <a href="login.php" class="login-btn">
                    <i class="fas fa-user"></i> Connection
                </a>
            </div>
        </div>
    </nav>
   ...
   <section class="hero">
    ...
    <div class="hero-content">
        <h1>Discover our Laptop collection</h1>
        <p>Exceptional performance for all your professional for all your professional and personal needs</p>
        <a href="#products" class="hero-btn">
            <i class="fas fa-shopping-bag"></i> Discover our product
        </a>
    </div>
</section>
  ...
  <section class="products-section" id="products">
        <div class="section-header">
            ...
            <p>Discover our selection of high-end computers designed to meet all your needs</p>
        </div>
...
<div class="product-card" data-price="89995">
    ...
    <div class="product-details">
        ...
        <p class="product-specs">
            ...
            <i class="fas fa-bolt"></i> Resting time 1ms<br>
...
<div class="product-card" data-price="199995">
    ...
    <div class="product-details">
        ...
        <p class="product-specs">
            ...
            <i class="fas fa-tint"></i> Encre 6 colors
        </p>
