...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <p>Exceptional performance for all your business and personal needs.</p>
            <a href="produit.php" class="hero-btn">
                <i class="fas fa-shopping-bag"></i>Discover our New Product
            </a>
        </div>
    </section>
    ...
    <div id="login-notification">
        <i class="fas fa-exclamation-circle"></i> Please log in to add to cart
    </div>

    <section class="filter-section" >
        <div class="filter-container" style="top: 0%; ">
            ...
            <?php foreach ($productsToShow as $product): ?>
                <div class="product-card"
                    ...
                    <?php if ($product === $newestProduct): ?>
                        <div class="new-product-banner">New!</div>
                    <?php endif; ?>
