                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label> Original price (cfa) <small>(optionnel)</small></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Badge <small>(ex: "New", "Promotion")</small></label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-product').click(function() {
                ...
                <small class="text-muted">Leave blank to keep this image </small>`
                    );
                } else {
                    $('#current_image_container').html('<small class="text-muted">Aucune image</small>');
                }
                ...
                // Set modal title
                $('#modalTitle').text('Modify the Product: ' + name);
